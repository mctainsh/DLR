...
/// <summary><c>GET /api/v1/about</c>.</summary>
[ApiController]
public sealed class AboutController : ControllerBase
{
	[HttpGet("/api/v1/about", Name = "About")]
	[AllowAnonymous]
	[EndpointSummary("The licence, the source repository and the exact commit of this build.")]
	public IActionResult Get(
		[FromServices] BuildInformation build,
		[FromServices] IOptions<AboutOptions> options) =>
		Ok(new AboutResponse(
...
public sealed class AboutOptions
{
	...
	/// construction.
	/// </summary>
	public string SourceUrl { get; set; } = "https://github.com/mctainsh/DLR";
}
