...
namespace DLR.Server.Data.Migrations
{
    ...
    [Migration("20260830022739_RemoveRiderPositions")]
    partial class RemoveRiderPositions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DLR.Server.Data.Comments.RideComment", b =>
                {
                    ...
                    b.HasIndex("TrackId", "AuthorId", "ClientGuid")
                        .IsUnique()
                    ...
                    b.ToTable("ride_comment", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_ride_comment_one_thread", "(group_ride_id IS NULL) <> (track_id IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("DLR.Server.Data.Identity.AppUser", b =>
                {
                    ...
                    b.Property<long>("PositionsRecorded")
                        .HasColumnType("bigint")
                        .HasColumnName("positions_recorded");
            ...
            modelBuilder.Entity("DLR.Server.Data.Tracks.Track", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("FirstSharedUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("first_shared_utc");
                    ...
                    b.HasIndex("PhotoId")
                        .HasDatabaseName("ix_track_photo_id");

                    b.HasIndex("RouteHash")
                        .HasDatabaseName("ix_track_route_hash")
                        .HasFilter("visibility = 'Public'");

                    b.HasIndex("BoundsMinLat", "BoundsMaxLat")
                    ...
                    b.HasIndex("Visibility", "FirstSharedUtc")
            ...
            modelBuilder.Entity("DLR.Server.Data.Tracks.TrackRating", b =>
                {
                    b.Property<Guid>("TrackId")
                        .HasColumnType("uuid")
                        .HasColumnName("track_id");
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_track_rating_user_id");

                    b.HasIndex("TrackId", "Stars")
                        .HasDatabaseName("ix_track_rating_track_stars");

                    b.ToTable("track_rating", null, t =>
                        {
                            t.HasCheckConstraint("ck_track_rating_stars", "stars BETWEEN 1 AND 5");
                        });
                });
            ...
            modelBuilder.Entity("DLR.Server.Data.Comments.RideComment", b =>
                {
                    ...
                    b.HasOne("DLR.Server.Data.Tracks.Track", "Track")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_ride_comment_track_track_id");
            ...
            modelBuilder.Entity("DLR.Server.Data.Tracks.Track", b =>
                {
                    ...
                    b.HasOne("DLR.Server.Data.Photos.Photo", "Photo")
                        ...
                        .HasForeignKey("PhotoId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_track_photo_photo_id");
            ...
            modelBuilder.Entity("DLR.Server.Data.Tracks.TrackRating", b =>
                {
                    b.HasOne("DLR.Server.Data.Tracks.Track", "Track")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_track_rating_track_track_id");
                    ...
                    b.HasOne("DLR.Server.Data.Identity.AppUser", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_track_rating_asp_net_users_user_id");
