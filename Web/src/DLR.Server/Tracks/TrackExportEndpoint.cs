...
public static class TrackExportEndpoint
{
	...
	public static IEndpointRouteBuilder MapTrackExport(this IEndpointRouteBuilder endpoints)
	{
		endpoints
			.MapGet("/api/v1/tracks/{id:guid}/gpx", GetAsync)
			.RequireAuthorization()
			.WithName(RouteName)
			.WithSummary("The track as GPX, with its markers as waypoints.");
